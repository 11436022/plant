CREATE DATABASE  IF NOT EXISTS `plant_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `plant_db`;
...
INSERT INTO `disease` VALUES (1,NULL,'白粉病','葉片有白粉病徵兆及蟲害啃食。','改善通風、控制濕度並清除病葉。若有蟲害，可手工移除或使用生物農藥。'),(2,NULL,'白粉病, 蟲害','葉片受白粉病感染，並有明顯蟲害咬食痕跡，植物健康受損。','白粉病可噴灑硫磺水或生物農藥。蟲害需手動移除或使用苦楝油防治。'),(3,NULL,'葉緣焦枯','葉片邊緣褐變、乾枯，並有不規則孔洞，疑為葉緣焦枯與蟲害。','穩定供水、改善通風，檢查並移除害蟲。可考慮補充鈣肥或使用有機防治。'),(4,NULL,'Anthracnose','移除病葉，改善通風濕度，避免葉面灑水。',NULL),(5,2,'炭疽病','葉片出現褐色不規則病斑，中心可能破裂，顯示受炭疽病感染。','清除病葉，保持良好通風，避免葉面長時間潮濕，嚴重時可使用登記農藥防治。'),(6,648,'白粉病','葉片上出現白色粉狀物，這是由真菌引起的白粉病。','移除受感染葉片，改善通風，減少濕度。可使用硫磺粉或苦楝油噴灑，嚴重時使用殺菌劑。'),(7,2,'葉斑病','葉面出現散佈的黑斑點，疑似葉斑病初步感染。','移除受感染葉片。保持良好通風，避免葉面長時間潮濕。必要時可考慮使用有機殺菌劑。');
...
-- Dump completed on 2026-03-25 15:06:07
